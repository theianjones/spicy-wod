(ns com.spicy
  (:require [com.biffweb :as biff]
            [com.spicy.email :as email]
            [com.spicy.app :as app]
            [com.spicy.home :as home]
            [com.spicy.worker :as worker]
            [com.spicy.schema :as schema]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (test/run-all-tests #"com.spicy.test.*"))
